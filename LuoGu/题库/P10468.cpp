...
public:
    StringHash(const string &str, uint64_t mod = UINT64_C(1000000007), uint64_t base = 131) : s(" " + str), mod(mod), base(base)
    {
    ...
    uint64_t getHash(size_t l, size_t r)
    {
...
public:
	static void Solve()
	{
		...
		while (m--)
		{
			int l1, r1, l2, r2;
			cin >> l1 >> r1 >> l2 >> r2;
			uint64_t hash1 = sh.getHash(l1, r1);
			uint64_t hash2 = sh.getHash(l2, r2);
